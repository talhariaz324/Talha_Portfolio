...
const greeting = {
  ...
  subTitle: emoji(
    "With our 2 years of experience, I am Full Stack Software Developer 🚀 having an experience of building Web and Mobile applications with JavaScript / Reactjs / Nodejs / React Native and some other cool libraries and frameworks."
  ),
  resumeLink:
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Proficiency in designing and implementing backend systems, infrastructure, and microservices architecture."
    ),
    emoji(
      "⚡ Experience in DevOps practices, including continuous integration and deployment, using tools like GitHub Actions and AWS."
    ),
    emoji(
      "⚡ Integration of third party services such as Firebase/ AWS / Digital Ocean"
    ),
    emoji(
      "⚡ Ability to engineer platforms for large-scale distributed systems, ensuring their reliability and scalability."
    ),
    emoji(
      "⚡ Familiarity with a range of tools and technologies, including Node.js, REST APIs, MongoDB, PostgreSQL, AWS, WebRTC, Websockets, and testing frameworks like Jest and Selenium."
    )
  ],
